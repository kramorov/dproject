...
from valve_data.models import ValveModelKvDataTable, ValveLineModelKvData
...
class ValveModelKvDataTableAdmin(admin.ModelAdmin) :
    ...
    change_form_template = 'admin/valve_data/valvemodelkvdatatable/change_form.html'
    ...
    def import_kv_data_view(self , request , object_id) :
        ...
        try :
            ...
            return render(request , 'admin/valve_data/valvemodelkvdatatable/import.html' , context)
