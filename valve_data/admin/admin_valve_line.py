...
def duplicate_selected_valve_line(model_admin , request , queryset) :
    for obj in queryset :
        try :
...
@admin.register(ValveLine)
class ValveLineAdmin(admin.ModelAdmin):
    change_list_template = 'admin/valve_data/valveline/change_list.html'
    change_form_template = 'admin/valve_data/valveline/change_form.html'
    list_display = (
    ...
    actions = [duplicate_selected_valve_line, 'export_as_text', 'export_with_sources']  # Добавлено новое действие
    ...
    def text_info_view(self, request, object_id):
        ...
        return render(request , 'admin/valve_data/valveline/text_info.html' , {
