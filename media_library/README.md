...
Замеченные ошибки:
при клике на превью изображения в списке открывается окно просмотра, в котором можно постранично листать все изображения, не только кликнутое. В карточке сущности такого нет.
Выпадающие списки не работают - они пустые. необходимо проверить настройку фильтров
В карточке редактирования не отображаются категория, бренд, тип оборудования
---
