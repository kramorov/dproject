...
#
#                 desc_table.extend([{'param_name' : 'Время открытия мин, сек:' , 'param_value' : time_to_open_min} ,
...
#                                         'param_value' : result_value[0].ip_choice.text_description} ,
#                                        {'param_name' : 'Напряжение питания, U питания, В:' ,
#                                         'param_value' : result_value[0].power_choice.text_description} ,
#                                        ])
#
...
#                                        {'param_name' : 'Сигнал обратной связи / Протокол:' ,
