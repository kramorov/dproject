...
#     StemShapes, StemSize, ThreadTypes, MeasureUnits, ThreadSize, CertData,  \
...
#     class Meta:
#         model = MeasureUnits
#         fields = ['id', 'symbolic_code', 'measure_type', 'text_description', 'symbolic_description']
#
#
...
#
#
# class CertVarietySerializer(serializers.ModelSerializer):
#     class Meta:
#         model = CertVariety
#         fields = ['symbolic_code', 'text_description']
#
#
# class CertDataSerializer(serializers.ModelSerializer):
#     class Meta:
#         model = CertData
#         fields = ['certificate_variety', 'symbolic_code', 'text_description', 'valid_from', 'valid_until']
#
