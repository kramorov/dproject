...
class GearBoxBody(CopyMixin,TemplateMixin,  models.Model):
    ...
    reduction_ratio_text = models.CharField(max_length=20, verbose_name=_("Передаточное число (текст)"),
    ...
    handwheel_diameter = models.PositiveIntegerField(verbose_name=_("Диаметр штурвала (мм)"),
    ...
    stem_height_top  = models.PositiveIntegerField(blank=True, null=True,
    ...
    stem_height_bottom = models.PositiveIntegerField(blank=True, null=True,
                                                     verbose_name=_("Высота штока"),
                                                     help_text=_('Глубина отверстия под шток арматуры'))
    max_stem_diameter_bottom = models.PositiveIntegerField(blank=True, null=True,
