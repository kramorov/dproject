# gearbox/catalog/views_list.py
"""
GET /api/gearbox/catalog/ — gearbox list with filters, search, prices.

Uses GEARBOX_CONFIG + SmartCatalogMixin.apply_filters_and_split().
"""
